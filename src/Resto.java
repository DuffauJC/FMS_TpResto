...
public class Resto {
	...
	public static void main(String[] args) {	
		...
		for(int i = 0 ; i < nbMenu ; i ++) {
			...
			String contenu = "Résumé de la commande "+(i+1)+" : \n";
			...
			try {
				...
				filePath = "C:\\Users\\Stagiaires08P\\eclipse-workspace\\FMS_TpResto\\order.txt";
				...
				System.out.println("Enregistrement de la commande terminée!");
